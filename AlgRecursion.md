...
```
#### 通过主键删除商品
DELETE http://127.0.0.1:8080/nearstBuy_war/Admin/Goods/{id}

例：
DELETE http://127.0.0.1:8080/nearstBuy_war/Admin/Goods/1a16095cd82d4ce89f0f23a2c4338c59
...
#### 通过id查询地址
GET http://127.0.0.1:8080/nearstBuy_war/Admin/Address/{id}
#### 增加地址
POST http://127.0.0.1:8080/nearstBuy_war/Admin/Address/
#### 通过主键修改地址
PUT http://127.0.0.1:8080/nearstBuy_war/Admin/Address/
#### 通过主键删除地址
DELETE http://127.0.0.1:8080/nearstBuy_war/Admin/Address/{id}
#### 分页获取地址列表
GET http://127.0.0.1:8080/nearstBuy_war/Admin/Address/{page}/{pagesize}

### 收藏

#### 通过id查询收藏
GET http://127.0.0.1:8080/nearstBuy_war/Admin/Collection/{id}
#### 增加收藏
POST http://127.0.0.1:8080/nearstBuy_war/Admin/Collection/
#### 通过主键修改收藏
PUT http://127.0.0.1:8080/nearstBuy_war/Admin/Collection/
#### 通过主键删除收藏
DELETE http://127.0.0.1:8080/nearstBuy_war/Admin/Collection/{id}
#### 分页获取收藏列表
GET http://127.0.0.1:8080/nearstBuy_war/Admin/Collection/{page}/{pagesize}
...
#### 通过id查询评论
GET http://127.0.0.1:8080/nearstBuy_war/Admin/Comment/{id}
#### 增加评论
POST http://127.0.0.1:8080/nearstBuy_war/Admin/Comment/
#### 通过主键修改评论
PUT http://127.0.0.1:8080/nearstBuy_war/Admin/Comment/
#### 通过主键删除评论
DELETE http://127.0.0.1:8080/nearstBuy_war/Admin/Comment/{id}
#### 分页获取评论列表
GET http://127.0.0.1:8080/nearstBuy_war/Admin/Comment/{page}/{pagesize}
